...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             TT(1),   KC_SPC ,KC_DEL,         KC_BSPC,KC_SPC , TT(2),            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             _______,   KC_SPC ,KC_DEL,         KC_BSPC,KC_ENT , _______,            KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),
  ...
  [2] = LAYOUT(
    ...
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_COLN, KC_DQT ,
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             MO(3),   KC_SPC ,KC_DEL,         KC_BSPC,KC_ENT , _______,            KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),
  ...
  [3] = LAYOUT(
    ...
    _______, _______  , _______, _______, QK_BOOT, _______,_______,                       _______, _______, _______, _______, _______, S_OC, _______,
    _______, _______, _______, _______, _______ , _______ ,_______,                       _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______
  )
