...
[0] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_ENT,
                 KC_BTN1,KC_BTN2,KC_LALT, TT(1), KC_LCTL,      KC_SPC,  TT(2), KC_RGUI, KC_PGDN, KC_PGUP
),
...
[2] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                        KC_PGUP, KC_BTN1,   KC_UP, KC_BTN1, S_OC, KC_BSPC,
